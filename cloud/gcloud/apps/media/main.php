...
<!DOCTYPE html>
    <head>
        ...
        <link rel="stylesheet" href="http://ray.haleblian.com/css/normalize.css">
        <link rel="stylesheet" href="http://ray.haleblian.com/css/main.css">
...
if ($disc_id == "") {
	...
	while ($row = mysql_fetch_assoc($result)) {
		if ($previous_dir != $row['dir']) {
		    echo "</p>";
			echo "<p><strong>", $row['dir'], "</strong></br>";
